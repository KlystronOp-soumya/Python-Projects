...
class son(parent):
    ...
    def son_display(self):
        mult= self.Percentage_for_son/100
        print("Share of Son is "+str(round(self.total_asset*mult,2))+" Million.")
...
class daughter(parent):
    ...
    def daughter_display(self):
        mult= self.Percentage_for_daughter/100
        print("Share of Daughter is "+str(round(self.total_asset*mult,2))+" Million.")
